...
async function sendToLLM(message) {
  ...
  // ═══════════════════════════════════════════════════════════════
  // INTENT: draft_request — Backend-driven draft + persistence
  // ═══════════════════════════════════════════════════════════════
  if (intent === 'draft_request' && allow_draft) {
    ...
    if (data.draft_id) {
      console.log('Draft persisted:', data.draft_id);
    }

    renderDraftWork(data.response);

    // Draft renders ONLY to Draft Work — skip Future Hause Response
    return null;
  }
